...
export default function Lanyard({ position = [0, 0, 30], gravity = [0, -40, 0], fov = 20, transparent = true }) {
  return (
    <div className="main-group relative z-0 w-full h-screen flex justify-center items-center transform scale-100 origin-center">
      <Canvas
...
function Band({ maxSpeed = 50, minSpeed = 0 }) {
  ...
  return (
    <>
      <group position={[0, 4, 0]} className="group">
